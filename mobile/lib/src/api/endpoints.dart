class Endpoints {
  ...
  static const auditLogs = '/api/v2/audit-logs';
  static const activityFeed = '/api/v2/activity-feed';
  ...
  static String floorDetails(int floorId) => '/api/floors/$floorId';
  ...
  static String announcementDetails(int id) => '/api/v1/announcements/$id';
  ...
  static String studentDetails(int studentId) => '/api/students/$studentId';
}
