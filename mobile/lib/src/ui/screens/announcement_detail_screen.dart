        ...
        return Padding(
          ...
          child: ListView(
            children: [
              ...
              Text('Status: ${announcement.currentStatus ?? announcement.status ?? 'Unknown'}'),
              if (announcement.audience != null) Text('Audience: ${announcement.audience}'),
              if (announcement.dorm != null) Text('Dorm: ${announcement.dorm?.name ?? ''}'),
              const SizedBox(height: 16),
