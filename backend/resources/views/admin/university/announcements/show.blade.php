...
@section('content')
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('admin.university.announcements.index') }}" class="btn btn-outline-secondary btn-sm">Back</a>
        </div>
    </div>
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    ...
                    <div class="fw-semibold mb-2">{{ ucfirst(strtolower($announcement->audience)) }}</div>
                    <div class="text-muted small mb-1">Dorm</div>
                    <div class="fw-semibold mb-2">{{ $announcement->dorm?->name ?? 'University-wide' }}</div>
