...
@section('content')
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('admin.dorm.tickets.edit', $ticket) }}" class="btn btn-outline-secondary btn-sm">Edit</a>
            <a href="{{ route('admin.dorm.tickets.index') }}" class="btn btn-outline-secondary btn-sm">Back</a>
        </div>
    </div>
    ...
    <div class="card shadow-sm mt-4">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('admin.dorm.tickets.comment', $ticket) }}">
                @csrf
                <div class="mb-2">
