...
@section('content')
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
        <div>
            ...
            <div class="text-muted">Manage maintenance requests for your dorm.</div>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('admin.dorm.tickets.export', request()->query()) }}" class="btn btn-outline-secondary">Export
                CSV</a>
            <a href="{{ route('admin.dorm.tickets.create') }}" class="btn btn-primary">New Ticket</a>
        </div>
    </div>

    <form method="GET" action="{{ route('admin.dorm.tickets.index') }}" class="row g-2 mb-3">
        <div class="col-md-5">
        ...
        <div class="col-12 d-flex gap-2">
            ...
            <a class="btn btn-outline-secondary" href="{{ route('admin.dorm.tickets.index') }}">Reset</a>
        </div>
    </form>
            ...
            <tbody>
                @forelse ($tickets as $ticket)
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="{{ route('admin.dorm.tickets.show', $ticket) }}"
                                class="btn btn-sm btn-outline-primary">View</a>
                            <a href="{{ route('admin.dorm.tickets.edit', $ticket) }}"
